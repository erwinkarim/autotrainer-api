...
var _awsSdk = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../aws-sdk\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
function main(event, context, callback) {
  ...
  var params = {
    TableName: "courses",
    // 'courses' contains the attributes of the item to be created
    // - 'userId': user identities are federated through the
    //             Cognito Identity Pool, we will use the identity id
    //             as the user id of the authenticated user
    // - 'courseId': a unique uuid
    // - 'name': parsed from request body
    // - 'description': parsed from request body
    // - 'picture': parsed from request body
    // - 'price': parsed from request body
